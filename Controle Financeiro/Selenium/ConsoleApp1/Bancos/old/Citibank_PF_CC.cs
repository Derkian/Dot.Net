...
//            UI.SetTextBoxValue(driver, By.Name("username"), "fepaiva");
...
//            UI.ClickWithJavascript(driver, executor, By.XPath(".//*[@id='login-box']/map/area[1]"));
//            UI.ClickWithJavascript(driver, executor, By.XPath(".//*[@id='login-box']/map/area[8]"));
//            UI.ClickWithJavascript(driver, executor, By.XPath(".//*[@id='login-box']/map/area[1]"));
//            UI.ClickWithJavascript(driver, executor, By.XPath(".//*[@id='login-box']/map/area[3]"));
